...
####NEED TO EDIT ON LINES 341 - onward <----------------------
####Notes####
...
#For GSEA paired t-test was used <-
...
######Finding top variable proteins (NOT USED)#######
...
#######Heatmap of significant proteins (NOT USED)##########
...
#######Obtain Heatmap with KEGG IDs (Not IMP for Figures)#######
...
######Extra Versions with Different Filters####
...
########BELOW THIS IS CONTENT THAT IS NOT IMPORTANT + BUT CAN KEEP FOR LATER USE#######
