...
#######16 cell WE inh#########
metab_16cell_inh <- read.csv(file = "Data/metab_data/inh_16cell_dataprocessed.csv")
...
write.csv(metab_16cell_inh$Query, file ="Output/metab_global/Files/metabnameinh_16cell.csv")
KEGGMOLID <- read.csv(file ="Data/metab_conv/name_map_16cell.csv")
...
#########2 day WE inh##########
metab_2day_inh <- read.csv(file = "Data/metab_data/inh_2day_dataprocessed.csv")
...
write.csv(metab_2day_inh$Query, file = "Output/metab_global/Files/metabnameinh_2day.csv")
KEGGMOLID_2 <- read.csv(file ="Data/metab_conv/name_map_2day.csv")
...
metab_micnm_inh <- read.csv(file = "Data/metab_data/micinh_data_processed.csv")
...
write.csv(metab_micnm_inh$Query, file = "Output/metab_global/Files/metabname_micnm_inh.csv")
KEGGMOLID_3 <- read.csv(file ="Data/metab_conv/name_map_micnminh.csv")
...
######MIC/NM 2019 sample######
metab_micnm <- read.csv(file = "Data/metab_data/data_processed_2019micnm.csv")
...
write.csv(metab_micnm$Query, file ="Output/metab_global/Files/metabname_micnm2019.csv")

KEGGMOLID_4 <- read.csv(file ="Data/metab_conv/name_map_micnm.csv")
...
write.csv(ALL_ID_conversions, file = "Output/metab_global/Files/name_map_alldatasets_manu.csv")
######Global Pathways#####
#Items to Prepare:
#May Replace with new color (figure dat S1 - S10) in the folder!
#Function to save plots into correct folder
global_map_save <- function(label){
  file.copy(from = paste0("spu01100.",label,".png"),
            to = paste0("Output/metab_global/Figures/","spu01100.",label,".png"))
  
  file.remove(from = paste0("spu01100.",label,".png"))
}
...
global_metab_timecourse_16cell_eggscale <- pathview(cpd.data =  subset(metab_timecourse_full_eggscale_pathview, select = c("Avg.16cell")),
                                                   ...
                                                   mid = list(cpd = "gray"),
                                                   high = list(cpd = "red"))
global_map_save("16cellscaleegg")
...
global_metab_timecourse_morula_eggscale <- pathview(cpd.data =  subset(metab_timecourse_full_eggscale_pathview, select = c("Avg.Morula")),
                                                   ...
                                                   mid = list(cpd = "gray"),
                                                   high = list(cpd = "red"))
global_map_save("morulascaleegg")
...
global_metab_timecourse_blastula_eggscale <- pathview(cpd.data =  subset(metab_timecourse_full_eggscale_pathview, select = c("Avg.Blastula")),
                                                   ...
                                                   mid = list(cpd = "gray"),
                                                   high = list(cpd = "red"))
global_map_save("blastulascaleegg")
...
global_metab_timecourse_gastrula_eggscale <- pathview(cpd.data =  subset(metab_timecourse_full_eggscale_pathview, select = c("Avg.Gastrula")),
                                                   ...
                                                   mid = list(cpd = "gray"),
                                                   high = list(cpd = "red"))
global_map_save("gastrulascaleegg")
...
global_metab_timecourse_pluteus_eggscale <- pathview(cpd.data =  subset(metab_timecourse_full_eggscale_pathview, select = c("Avg.Pluteus")),
                                                   ...
                                                   mid = list(cpd = "gray"),
                                                   high = list(cpd = "red"))
global_map_save("pluteusscaleegg")
...
#MIC vs NM
write.csv(metab_micnm_full_pathview, file = "Output/data_files_for_app/mic.m.nm.metabolomics.csv")
#Mic vs NM inh
write.csv(metab_micnmratio_pathview, file = "Output/data_files_for_app/mic.m.nm.inh.metabolomics.csv")
#Timecourse
write.csv(metab_timecourse_full_pathview, file = "Output/data_files_for_app/timecourse_metabolomics_global.csv")
